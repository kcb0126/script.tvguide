...
def EPG_time_2(self):
     ...
     if int(programs_width) == 344:
         ...
         if int(nextprogram_width) >= 40 and int(nextprogram_width) <= 60:
             ...
             nextprograms_width = 407
             program_button_2.setWidth(int(nextprograms_width))

             if int(nextprograms_width) == 407:
     ...
     if program_finished == '05' or program_finished == '35':
         ...
         if int(programs_width) == 177:
             ...
             if int(nextprogram_width) >= 40 and int(nextprogram_width) <= 59:
                 ...
                 nextprograms_width = 332
                 program_button_2.setWidth(int(nextprograms_width))

                 if int(nextprograms_width) == 332:
                     program_button_3.setPosition(897, int(pos_Y))
                     nextprogram1_width = program_button_3.getWidth()
...
def epg_times_stamp(self):
     ...
     print "epg_times_stamp is calling...................."
     print self.program_day


     if half_hour == "12:00AM":
         print "you are in the epg_time_1...................."
         
         day_date = self.program_day
         print "day_date"
         print day_date

         if day_date >= 1 and day_date <= 6:
             print "self.program_day is"
             print self.program_day
             print "you have now added next day and self.program_day is"
             print self.program_day

             if self.program_day == 1:
                 print "you are in the program_day 1 under epg_time_2..............a"
                 today_day = time.strftime("%d")
                 today_day = int(today_day) + 1
                 next_day = int(today_day) 
                 next_day = int(today_day)
                 next_day = str(next_day)
                 print "you are in the day 1"
                 print next_day
             ...
             elif self.program_day == 2:
                 print "you are in the program_day 2 under epg_time_2.............."
                 today_day = time.strftime("%d")
                 today_day = int(today_day) + 2
                 next_day = int(today_day) 
                 next_day = int(today_day)
                 next_day = str(next_day)
                 print "today_day for epg_time_1 is.......a"
                 print today_day
                 print "next_day date"
                 print next_day
             ...
             elif self.program_day == 3:
                 print "you are in the program_day 3 under epg_time_2.............."
                 today_day = time.strftime("%d")
                 today_day = int(today_day) + 3
                 next_day = int(today_day) 
                 next_day = int(today_day)
                 next_day = str(next_day)
             ...
             elif self.program_day == 4:
                 print "you are in the program_day 4 under epg_time_2.............."
                 today_day = time.strftime("%d")
                 today_day = int(today_day) + 4
                 next_day = int(today_day) 
                 next_day = int(today_day)
                 next_day = str(next_day)
             ...
             elif self.program_day == 5:
                 print "you are in the program_day 5 under epg_time_2.............."
                 today_day = time.strftime("%d")
                 today_day = int(today_day) + 5
                 next_day = int(today_day) 
                 next_day = int(today_day)
                 next_day = str(next_day)
             ...
             elif self.program_day == 6:
                 print "you are in the program_day 6 under epg_time_2.............."
                 today_day = time.strftime("%d")
                 today_day = int(today_day) + 6
                 next_day = int(today_day) 
                 next_day = int(today_day)
                 next_day = str(next_day)
         ...
         self.epg_time_2.append(one_hour_date)
         self.epg_time_3.append(one_hour_half_date)


     elif one_hour == "12:00AM":
         print "you are in the epg_time_2...................."
         day_date = self.program_day
         print "day_date"
         print day_date
         ...
         if day_date >= 1 and day_date <= 6:
             ...
             if self.program_day == 1:
                 print "you are in the program_day 1 under epg_time_2..............b"
                 today_day = time.strftime("%d")
                 today_day = int(today_day)
                 next_day = int(today_day) 
                 next_day = int(today_day) + 1
                 next_day = str(next_day)
                 print "you are in the day 1"
                 print next_day
                 ...
                 next_day = int(today_day) + 1
                 next_day = str(next_day)
                 print "today_day for epg_time_1 is.......b"
                 print today_day
                 print "next_day date"
                 print next_day
             ...
             print "you are in the program_day 0 under epg_time_2.............."
             today_day = time.strftime("%d")
             today_month = time.strftime("%m")
             today_year = time.strftime("%Y")
             epg_time_1_days = int(today_day)
         ...
         print "you are in the epg_time_3...................."
         print "you are in 12am"
         day_date = self.program_day
         print "day_date"
         print day_date
         ...
         if day_date >= 0 and day_date <= 6:
             ...
             if self.program_day > 1 and self.program_day <= 6:
                 today_day = time.strftime("%d")
                 today_day = int(today_day)
                 today_day = int(today_day) + int(self.program_day) - 1
                 today_day = str(today_day)
                 print "today_day today is..............."
                 print today_day

                 if self.program_day == 2:
                     next_day = int(today_day) 
                     next_day = int(today_day) + 1
                     next_day = str(next_day)
                 elif self.program_day == 3:
                 ...
                 epg_time_2_months = str(epg_time_1_months)
                 epg_time_2_year = str(today_year)
                 epg_time_3_days = str(next_day)
                 epg_time_3_months = str(epg_time_1_months)
                 epg_time_3_year = str(today_year)


             else:
                 print "you are in the epg_time_3 else...................."
                 today_day = time.strftime("%d")
                 next_day = int(today_day) 
                 next_day += int(self.program_day)
                 next_day = str(next_day)
                 today_month = time.strftime("%m")
                 today_year = time.strftime("%Y")
                 epg_time_1_days = int(today_day)
             ...
             one_hour_date = str(epg_time_2_days + "/" + epg_time_2_months + "/" + epg_time_2_year + " " + one_hour)
             one_hour_half_date = str(epg_time_3_days + "/" + epg_time_3_months + "/" + epg_time_3_year + " " + one_hour_half)
             print "self.program_day at the bottom"
             print self.program_day
         ...
         print "you are in the epg_time else...................."
         today_day = time.strftime("%d")
         today_month = time.strftime("%m")
         today_year = time.strftime("%Y")
         local_time_zone = time.strftime("%p")
         print "you are in the else"
         print one_hour_half
         program_time_zone = one_hour_half.split(':')[1].replace('00', '').replace('30', '')
         print "one_hour_half"
         print one_hour_half
         print "program_time_zone"
         print program_time_zone


         if local_time_zone == 'PM':
             if program_time_zone == 'AM':
                 print "you are in the timezone 1"
                 day_date = self.program_day
                 print "day_date"
                 print day_date

                 if day_date >= 1 and day_date <= 6:
                     print "you are in day_date 1 and 6"
                     today_day = time.strftime("%d")
                     next_day = int(today_day)
                     next_day += int(self.program_day)
                     print "next_day in timezone 1"
                     print next_day
                     next_day = str(next_day)
             ...
             elif program_time_zone == 'PM':
                 print "you are in the timezone 2"
                 day_date = self.program_day
                 print "day_date"
                 print day_date
                 ...
                 if day_date >= 1 and day_date <= 6:
                     print "you are in day_date 1 and 6"
                     today_day = time.strftime("%d")
                     today_day = int(today_day) + int(day_date)
                     ...
                     print "you are in day_date else"
                     today_day = time.strftime("%d")
                     epg_time_1_days = int(today_day)
                     epg_time_1_days = str(epg_time_1_days)
                     epg_time_1_months = str(today_month)
         ...
         elif local_time_zone == 'AM':
             if program_time_zone == 'AM':
                 print "you are in the timezone 3"
                 day_date = self.program_day
                 print "day_date"
                 print day_date
                 ...
                 if day_date >= 1 and day_date <= 6:
                     ...
                     if day_date == 1:
                         if half_hour == "12:00AM":
                             print "you are in the epg_time_1 in day 1 at 12am area....................A"
                             epg_time_1_days = int(next_day)
                             epg_time_1_days = str(epg_time_1_days)
                             epg_time_1_months = str(today_month)
                             epg_time_1_year = str(today_year)
                             ...
                             print "you are in the epg_time_2 in day 1 at 12am area....................B"
                             epg_time_1_days = int(next_day)
                             epg_time_1_days = str(epg_time_1_days)
                             epg_time_1_months = str(today_month)
                             epg_time_1_year = str(today_year)
                             ...
                             print "you are in the epg_time_3 in day 1 at 12am area....................C"
                             epg_time_1_days = int(next_day)
                             epg_time_1_days = str(epg_time_1_days)
                             epg_time_1_months = str(today_month)
                             epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 2 area....................D"
                         epg_time_1_days = int(next_day)
                         epg_time_1_days = str(epg_time_1_days)
                         epg_time_1_months = str(today_month)
                         epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 3 area....................E"
                         epg_time_1_days = int(next_day)
                         epg_time_1_days = str(epg_time_1_days)
                         epg_time_1_months = str(today_month)
                         epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 4 area....................F"
                         epg_time_1_days = int(next_day)
                         epg_time_1_days = str(epg_time_1_days)
                         epg_time_1_months = str(today_month)
                         epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 5 area....................G"
                         epg_time_1_days = int(next_day)
                         epg_time_1_days = str(epg_time_1_days)
                         epg_time_1_months = str(today_month)
                         epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 6 area....................H"
                         epg_time_1_days = int(next_day)
                         epg_time_1_days = str(epg_time_1_days)
                         epg_time_1_months = str(today_month)
                         epg_time_1_year = str(today_year)
                 ...
                 print "you are in the timezone 4"
                 day_date = self.program_day
                 print "day_date"
                 print day_date
                 ...
                 if day_date >= 1 and day_date <= 6:
                     ...
                     if day_date == 1:
                         if half_hour == "12:00AM":
                             print "you are in the epg_time_1 in day 1 at 12am area....................H"
                             epg_time_1_days = int(next_day)
                             epg_time_1_days = str(epg_time_1_days)
                             epg_time_1_months = str(today_month)
                             epg_time_1_year = str(today_year)
                             ...
                             print "you are in the epg_time_2 in day 1 at 12am area....................I"
                             epg_time_1_days = int(next_day)
                             epg_time_1_days = str(epg_time_1_days)
                             epg_time_1_months = str(today_month)
                             epg_time_1_year = str(today_year)
                             ...
                             print "you are in the epg_time_3 in day 1 at 12am area....................J"
                             epg_time_1_days = int(next_day)
                             epg_time_1_days = str(epg_time_1_days)
                             epg_time_1_months = str(today_month)
                             epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 2 area....................K"
                         epg_time_1_days = int(next_day)
                         epg_time_1_days = str(epg_time_1_days)
                         epg_time_1_months = str(today_month)
                         epg_time_1_year = str(today_year)
                         ...
                         print "you are in the day 3 area....................L"
                         epg_time_3_days = int(epg_time_2_days) + 2
                         epg_time_3_days = str(epg_time_3_days)
                         epg_time_3_months = str(epg_time_2_months)
                         epg_time_3_year = str(epg_time_2_year)
                     elif day_date == 4:
                         print "you are in the day 4 area....................M"
                         epg_time_3_days = int(epg_time_2_days) + 3
                         epg_time_3_days = str(epg_time_3_days)
                         epg_time_3_months = str(epg_time_2_months)
                         epg_time_3_year = str(epg_time_2_year)
                     elif day_date == 5:
                         print "you are in the day 5 area....................N"
                         epg_time_3_days = int(epg_time_2_days) + 4
                         epg_time_3_days = str(epg_time_3_days)
                         epg_time_3_months = str(epg_time_2_months)
                         epg_time_3_year = str(epg_time_2_year)
                     elif day_date == 6:
                         print "you are in the day 6 area....................O"
                         epg_time_3_days = int(epg_time_2_days) + 5
                         epg_time_3_days = str(epg_time_3_days)
                         epg_time_3_months = str(epg_time_2_months)
                         epg_time_3_year = str(epg_time_2_year)
         ...
         if self.channel_page >= 0:
             ...
             if self.move_right_flag == False:
                 ...
                 if CurrentRow:
                     ...
                     print "self.epg_time_1"
                     print self.epg_time_1
                     print "self.epg_time_2"
                     print self.epg_time_2
                     print "self.epg_time_3"
                     print self.epg_time_3
                     ...
                     if epg_time1 == '12:00AM':
                         epg_time_1 = datetime.now() + timedelta(days=1)
                     elif epg_time2 == '12:00AM':
                         epg_time_2 = datetime.now() + timedelta(days=1)
                     elif epg_time3 == '12:00AM':
                         epg_time_3 = datetime.now() + timedelta(days=1)
                     else:
                         epg_time_1 = datetime.now() + timedelta(days=0)
                         print "epg_time_1"
                         print epg_time_1
